# Django settings for igoodybag project.
...
SECRET_KEY = 'wh!c4orn1^a!kdf9zykp_$_hzwxi162$8#ydlop_q2df85op+j'
...
ROOT_URLCONF = 'igoodybag.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'igoodybag.wsgi.application'
